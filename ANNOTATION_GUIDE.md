...
### Класс 0: Защитная каска (helmet) - ОРАНЖЕВАЯ ИЛИ БЕЛАЯ
- Основные цвета для детекции: **оранжевый** и **белый**
- Разные типы защитных касок (оранжевые, белые, желтые)
- Разные углы обзора (особенно важен высокий угол - камера сверху)
- Разные условия освещения
- Каски могут быть очень маленькими при высоком угле обзора
